...
namespace DisasterManagement.Migrations
{
    ...
    [Migration("20251003125826_Frist")]
    partial class Frist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DisasterManagement.Models.DonationItem", b =>
                {
            ...
            modelBuilder.Entity("DisasterManagement.Models.IncidentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DisasterManagement.Models.VolunteerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DisasterManagement.Models.VolunteerTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DisasterManagement.Models.Donation", b =>
                {
                    b.HasOne("ApplicationUser", "Donor")
                        .WithMany()
            ...
            modelBuilder.Entity("DisasterManagement.Models.DonationItem", b =>
                {
                    b.HasOne("DisasterManagement.Models.Donation", "Donation")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("DisasterManagement.Models.VolunteerTask", b =>
                {
                    b.HasOne("ApplicationUser", "AssignedVolunteer")
                        .WithMany()
                        .HasForeignKey("AssignedVolunteerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DisasterManagement.Models.VolunteerProfile", "VolunteerProfile")
                        .WithMany("Tasks")
